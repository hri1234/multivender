...
import logo from '../../../assets/images/Banners/logo3.jpg';
...
const Header = () => {
  ...
  return (
    ...
    <header className="bg-primary-blue fixed top-0 py-2.5 w-full z-10" style={{backgroundColor:'black'}}>

      {/* <!-- navbar container --> */}
      <div className="w-full sm:w-9/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
        <Link to='/'> <img src={logo} alt="" className='img-fluid' style={{width:'170px', height:"40px"}}/>
      {/* <h1 style={{color:'white', fontSize:'22px', fontFamily:'sans-serif', fontStyle:'italic',fontWeight:'900' , color:'#e30838'}}>Smashdeals</h1> */}
      </Link>
