...
import { clearErrors, registerSell } from '../../actions/sellAction';
...
const Form = () => {
  ...
  // const { loading, isAuthenticated, error } = useSelector((state) => state.isAuthenticated);
  ...
  const { name, email, gender, password, cpassword, product_name, product_cat } = sell;
  ...
  const handleRegister = (e) => {
      ...
      formData.set("product_cat", product_cat);
      formData.set("password", password);
      formData.set("avatar", avatar);

      dispatch(registerSell(formData));
  }
                  ...
                  <div className="flex-1 overflow-hidden">
                      ...
                      >
                          {/* <div className="flex flex-col gap-4 items-start"> */}
                              ...
                              <Link to="/SellLogin" className="hover:bg-gray-50 text-primary-blue text-center py-3 w-full shadow border rounded-sm font-medium">Existing Seller? Log in</Link>
                          </div>
