...
import { clearErrors, loginSell } from '../../actions/sellAction';
...
const SellLogin = () => {
    ...
    // const { loading, isAuthenticated, error } = useSelector((state) => state.sell);
    ...
    const handleLogin = (e) => {
        e.preventDefault();
        dispatch(loginSell(email, password));
    }
    ...
    return (
        <>
            <MetaData title="Login Seller| Flipkart" />
            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    ...
                    <div className="loginSidebar bg-primary-blue p-10 pr-12 hidden sm:flex flex-col gap-4 w-2/5">
                        ...
                        <p className="text-gray-200 text-lg">Get access to Seller page, Wishlist and Recommendations</p>
                    </div>
                    {/* <!-- sidebar column  --> */}
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        <div className="text-center py-10 px-4 sm:px-14">
                            ...
                            <Link to="/Form" className="font-medium text-sm text-primary-blue">New to Flipkart? Create an account</Link>
                        </div>
                        {/* <!-- edit info container --> */}
