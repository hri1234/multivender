...
import Shiping from './components/Policy/Shiping';
import Cancle from './components/Policy/Cancle';
import Payments from './components/Policy/Payments';
import Form from './components/Sellpage/Form'

import Wholeshale from './components/Wholeshale/Wholeshale';
import GiftCard from './components/GiftCard/GiftCard';
import Stories from './components/Stories/Stories';
import SellLogin from './components/Sellpage/SellLogin';
import Ankit from "./components/Home/Ankit/Ankit"
function App() {
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/wholesale" element={<Wholeshale />} />
...
<Route path="/admin/sell/:id" element={
          <ProtectedRoute isAdmin={true}>
            <Dashboard activeTab={4}>
              <UpdateUser />
            </Dashboard>
